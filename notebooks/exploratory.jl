...
# ╔═╡ 21dc2e78-aaa6-11ec-2de1-59008fe88c15
...
# ╔═╡ 5637e49e-b964-4604-a8b2-fb3195c5a0b4
κ = 1.

# ╔═╡ 1b4c2444-1e0a-4971-8801-62a44f6eabb5
unit = range(0, 1; length = 101)

# ╔═╡ 51bb97fc-4475-4253-9573-974dcb26536e
md"

``m``: $(@bind m Slider(range(1, 100, step = 1), default = 2, show_value = true)) 

``\mu`` : $(@bind μ Slider(unit, default = 0.1, show_value = true)) 

"

# ╔═╡ c71b3773-52f2-4f30-a14e-b2dc3c6b9d42
p(γ, pₚ) = (1 - μ) * (1 - (1 - pₚ)^(m * γ))

# ╔═╡ 068e940b-8781-4838-96a9-7b0c82342983
begin
	contourf(
		unit, unit, p; xlabel = L"\gamma", ylabel = L"p_{i-1}",
		clims = (0, 1)
	)
end
