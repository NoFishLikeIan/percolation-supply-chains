...
# ╔═╡ 1a796610-42f0-47e4-b012-40a8aa53e391
begin
	# Packages
	using Agents
	using Graphs
...
# ╔═╡ 17b563fc-a445-11ec-1db9-914ee6e7f4a3
include("../src/main.jl")

# ╔═╡ a41d95fe-9c9f-452b-b9b7-841d777689fe
begin
	m = [10, 2, 10] # Market sizes
...
# ╔═╡ 63c45b5e-0ef5-47f9-a1fd-b23594234b1b
begin
	model = verticaleconomy(m, μ, payoff, θ, Fₛ; λ = 1.)
	
	T = 70
	
	data, _ = run!(
	    model, dummystep, model_step!, T; 
	    adata = [:isfunctional, :x, :θ, :realized]
	)

	n = sum(m)
end

# ╔═╡ 331be764-cfdc-4872-801f-8adc09385aff
data

# ╔═╡ e227808f-eb77-4736-a1f6-5e6e82d6fabf
