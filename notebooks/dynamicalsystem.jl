...
# ╔═╡ d5e9dc9c-7985-458b-b31a-bc0ce4199ab9
begin
	K = 20 # Length economy
	m = 100 # Size nodes
	μ₀ = 0.05 # Basal risk
...
md"
``s`` $(@bind sₖ Slider(
	0.5:0.01:2, show_value = true, default = 1.
))
"
...
begin
	...
	ρspace = range(0.01, 0.7; length = L)
...
let
	Φ(f, ρ) = model.G([f, ρ]; sₖ = sₖ) .- [f, ρ]
	plotvectorfield(Φ, fspace, ρspace)
end
